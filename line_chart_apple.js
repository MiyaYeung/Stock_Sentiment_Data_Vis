...
//*************** line chart of stock (left) ******************//

//--------------- initialise line chart

//initialise canvas
var graph_stock_left = d3.select("svg#svg-stock-left")
...
var plot_stock_left = graph_stock_left.append("g")
.attr("class", "plot-stock")   
.attr("id", "plot-stock-left")
.attr("width", width)
.attr("height", height)
.attr("transform", "translate(" + margin.left + "," + margin.top + ")");

//Append chart title
graph_stock_left.append("text")
.attr("id","title-graph-stock-left")
.attr("transform", "translate(100,0)")
.attr("x", 100)
.attr("y", 30)
.attr("font-size", "14px")
.attr("stroke", "black")
.text("Apple stock performance"); 

//--------------- read data, draw line chart
// read data for stock line chart
d3.dsv(",", "stock/stock_apple_with_prediction.csv", function(d) {

    // console.log("apple stock with prediction from csv: ", d);
    ...
    // console.log("apple stock data for extraction", data);
    ...
    // console.log("Apple stock with prediction", DataForPlotClose);

    var FilterDataForPlotClose = DataForPlotClose.filter(function(d, i) { return i < DataForPlotClose.length - 7 })
    // console.log("apple data for ploting the actual line: ", FilterDataForPlotClose)

    //get d.actual and d.yhat and d.sigma
    ...
    // console.log("Apple actual and yhat subgroups of DataForPlotClose:" , subgroups);
    ...
    //create x axis
    var x_axis = plot_stock_left.append("g")
    .call(xAxis)
    .attr("id","x-axis-stock-left")
    ...
    //Create Y axis
    var y_axis = plot_stock_left.append("g")
    .call(yAxis)
    .attr("id","y-axis-a")
    .attr("class", "axis")
    ...
    graph_stock_left.append("g")
    .attr("class", "legend")
    .attr("id", "legend-stock-left")
    ...
    var lines = plot_stock_left.append("g")
                .attr("class", "lines")
                .attr("id", "lines-plot-stock-left");
